...
`wickra-feature-store` is analysis software. It evaluates conditions over market data
...
- **Caller → core.** Everything arriving through `Feature-Store::command` (spec, data,
