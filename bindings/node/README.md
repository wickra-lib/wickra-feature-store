...
**Turn OHLCV and microstructure event streams into ML-ready feature matrices over 497 O(1) streaming indicators — for Node.js. `npm install wickra-feature-store` — prebuilt native binary, no system dependencies.**
...
- **Runnable example:** [`examples/node/`](https://github.com/wickra-lib/wickra-feature-store/tree/main/examples/node)
